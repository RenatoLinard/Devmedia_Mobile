...
import xbox from '../../assets/xbox_img.png';
    ...
    return(
          ...
          <ScrollView style={styles.container}>
             <View style={styles.tarja}>
                  <Text style={styles.textTarja}> Historia do Xbox </Text>
             </View>
            ...
            <View style={styles.containerCard}>
                ...
                <View style={styles.cardEspecif}>
                    ...
                    style={styles.icon}
                    />
                    <Text style={styles.textoEspecif}> 733 MHz Intel Pentium III</Text>
                </View>
                ...
                <View style={styles.cardEspecif}>
                    <Image
                        ...
                        style={styles.icon}
                    />
                    <Text style={styles.textoEspecif}> Nvidia GeForce 233 MHz</Text>
                </View>
                ...
                <View style={styles.cardEspecif}>
                    <Image
                        ...
                        style={styles.icon}
                    />
                    <Text style={styles.textoEspecif}>65 MB of DDR SDRAM 200 MHz</Text>
                ...
                <View style={styles.cardEspecif}>
                    <Image
                        ...
                        style={styles.icon}
                    />
                    <Text style={styles.textoEspecif}>HD interno de 8GB</Text>
